...
export default function SubHeader() {
  return (
    <main id="home" className="herobg-gradient-slant flex justify-between">
      <ul className="px-20 pt-28 py-20 text-white font-black duration-300">
        <li className="sm:text-xl md:text-2xl lg:text-2xl pb-4 font-bold">
          Hello<span className="animate-pulse">👋</span>
        </li>
        <li className="text-6xl leading-10">I'am a web</li>
        <li className="text-7xl pb-4">Developer</li>
        <li className="text-2xl font-semibold">I build things for web.</li>
